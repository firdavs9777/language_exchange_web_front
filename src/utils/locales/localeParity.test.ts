...
const NAMESPACES = ["seo", "notFound", "consent", "admin", "moments_section", "home", "download", "meet", "learnKorean", "communities", "errors", "growth", "profile", "editMoment", "communityMain", "communityDetail"];
