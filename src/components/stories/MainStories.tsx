...
const MainStories: React.FC = () => {
  ...
  // Get stories feed
  const { data: feedData, isLoading: isLoadingFeed, error: feedError } = useGetStoryFeedsQuery();
      ...
      <div className="stories-page">
        <Container className="stories-container">
          <Alert variant="danger">
            {t("stories.error_loading") || "Error loading stories"}
          </Alert>
        </Container>
      </div>
    );
  ...
  return (
    <div className="stories-page">
      <Container className="stories-container">
        <h1 className="stories-title mb-4">
          {t("stories.title") || "Stories"}
        </h1>

        {/* Stories Feed - Horizontal Scrollable */}
        ...
        {/* Empty State */}
        {storyFeed.length === 0 && myStories.length === 0 && (
          <div className="stories-empty-state">
            <div className="empty-icon">
              <FaCircle />
            </div>
            <h3>{t("stories.no_stories") || "No Stories Yet"}</h3>
            <p>{t("stories.no_stories_desc") || "Create your first story to share with friends!"}</p>
            {userId && (
